...
class Mesh(object):
    ...
    def __init__(self, N, a, b):
        ...
        #  Node I uses cells I-1 and I.
       # self.__node = np.append ( [ 0 range(N), range(1,N+1) ] )
    ...
    def spacing(self):
        return (self.__b-self.__a)/self.__N
...
class Shapefns(object):
    ...
    def __init__(self):
        ...
        # derivative of second factor * first + derivative of first factor *
        # second
...
#     """
#     Plots the solution vector by linearly combining with Shapefns
#     """
...
if __name__ == '__main__':
    ...
    if N == 5 and np.abs(coords[-1]-5.0) < 1.e-10:
        ...
        print(
            "elt integral() err=",
            max(abs(elt.integral() - [1. / 6, 2. / 3, 1. / 6])))
        print(
            "integral(deriv) err=",
